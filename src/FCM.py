# source: https://github.com/jeongHwarr/various_FCM_segmentation/blob/master/FCM.py
#import os
...
class FCM():
    def __init__(self, image, image_bit, n_clusters, m, epsilon, max_iter, verbose=False):
